		...
		<fieldset id="imageUploadFieldset">
			...
			<div id="uploadImageSelect">
				<fieldset class="listFieldset">
						...
						<div>
							<div class="listFieldsetDiv">
								<div class="categoryClass1">
									<label>大图片1</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div>
							</div>
						...
						<div>
							<div class="listFieldsetDiv">
								...
								<div class="categoryClass2">
									<label>大图片2</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div> 
							</div>
							<div class="listFieldsetDiv">
								<div class="categoryClass1">
									<label>大图片3</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div>
							
								<div class="categoryClass2">
									<label>大图片4</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div> 
							</div>
							<div class="listFieldsetDiv">
								<div class="categoryClass1">
									<label>大图片5</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div>
					...
					<!-- 我的购物车图片 -->
					<fieldset class="listFieldset">
					<legend>我的购物车图片</legend>
						<div>
							<div class="listFieldsetDiv">
								 <div class="categoryClass1">
									<label>小图片</label><input type="file"  name="cdesc" id="cdesc" class="btn-warning"/>
								</div>
							</div>
						</div>
				</fieldset>	
