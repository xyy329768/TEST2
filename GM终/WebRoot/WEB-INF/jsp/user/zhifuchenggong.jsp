...
<html>
	...
	<% User user = (User)session.getAttribute("user");%>
		...
		<script type="text/javascript">
			var time= 10;
			var interval= window.setInterval(tiaoZhuan,1000);
			function tiaoZhuan () {
				...
				if(time>0){
					...
					location.assign("myOrderServlet?action=getAllMyOrderByPage&requestPage=1&userid=<%=user.getUserid() %>");
				}
			}
		</script>
	</head>
	<body id="body">
		<div id="all">
			...
			<div id="middel">
				...
				<div id="jump">
					<font id="ten" color="gray" size="2">10</font>
					<span >s后自动跳到我的订单界面,您也可以点击</span>
					<a href="myOrderServlet?action=getAllMyOrderByPage&requestPage=1&userid=<%=user.getUserid() %>" >自动跳到我的订单界面></a>
				</div>
