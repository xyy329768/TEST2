...
<html>
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/css1/down.css"/>
		<link rel="stylesheet" type="text/css" href="css/css1/up.css"/>
		<script type="text/javascript" src="js/js1/index.js"></script>
		<script type="text/javascript" src="js/js1/jd.js"></script>
		<script type="text/javascript" src="js/js1/colorChange.js"></script>
		<style type="text/css">
			body {
	...
	#div1 {
			...
			#shortcut #ttbar-apps .dt .ci-left {
				...
				width: 15px;
				height: 20px;
				background: url(img1/images2/jd2015img.png) 0 0 no-repeat;
			}
			
			#shortcut #ttbar-apps:hover .dt .ci-left {
				background: url(img1/images2/jd2015img.png) 0 -25px no-repeat;
			}
			...
			#logo .logo {
				...
				width: 270px;
				height: 60px;
				background: url(img1/images2/logo-201305.png) no-repeat 0 0;
				text-indent: -20000px;
			}
			...
			#settleup .ci-left {
				...
				width: 18px;
				height: 16px;
				background: url(img1/images2/jd2015img.png) 0 -58px no-repeat;
			...
			#settleup-content .loading {
				display: block;
				height: 50px;
				background: url(img1/images2/loading.gif) no-repeat center center;
			}
			...
			#settleup .nogoods b {
				...
				width: 56px;
				height: 49px;
				background-image: url(img1/images2/settleup-nogoods.png);
			}
			...
			#categorys .subitems .style-red-border .right-b {
				float: left;
				background: url(img1/images2/smil.png) no-repeat 0 0;
				width: 5px;
				height: 16px
			}
...
.succ-icon {
    ...
    height: 25px;
    overflow: hidden;
    background: url(img1/images2/addtocart-icons.png) 0 0 no-repeat;
}
...
.btn-addtocart b {
    ...
    height: 20px;
    overflow: hidden;
    background: url(img1/images2/addtocart-icons.png) -20px -81px no-repeat;
}
...
.card-lists .card-msg .msg-bottom {
    ...
    height: 6px;
    overflow: hidden;
    background: url(img1/images2/addtocart-icons.png) 0 -35px repeat-x;
}	
.card-lists .p-price {
    width: 100%;
    height: 19px;
...
.card-lists .btn-append b, .goods-list .btn-append b {
    background-image: url(img1/images2/addtocart-icons.png);
}
...
#service-2014 .slogen .fore1 i {
    background-image: url(img1/images2/duo.png);
}
#service-2014 .slogen .fore2 i {
    background-image: url(img1/images2/kuai.png);
}
#service-2014 .slogen .fore3 i {
    background-image: url(img1/images2/hao.png);
}
#service-2014 .slogen .fore4 i {
    background-image: url(img1/images2/sheng.png);
}
						...
						<div class="dorpdown-layer" id="category-dorpdown-layer">
							<div class="item-sub" id="category-item-1" data-id="1">
								<div class="item-brands">
									<div class="brands-inner">
										<a href="" class="img-link" target="_blank"><img src="img1/images2/54d9ef34N7cc61f4c.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/5534f4d6N6cf59e34.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/55a5b5baN89a65ec2.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/55b1d930Nf0bfccbb.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/562f4971Na5379aba.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/564a8df2Nbab8fdab.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/56a6d27cNbb9b4a77.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/56a72d4fN4d1b42fe.jpg" width="83" height="35"></a>
									</div>
								</div>
								<div class="item-channels">
									<div class="channels">
										...
										<a href="" target="_blank">国美净化馆<i>&gt;</i></a>
										<a href="" target="_blank">国美帮服务店<i>&gt;</i></a>
								...
								<div class="item-promotions">
									<a href="" class="img-link" target="_blank"><img src="img1/images2/577f019cN4ea29161.jpg" width="168" height="134"></a>
									<a href="" class="img-link" target="_blank"><img src="img1/images2/577e364eN86c8f187.jpg" width="168" height="134"></a>
								</div>
							</div>
							<div class="item-sub" id="category-item-2" data-id="2">
								...
								<div class="subitems">
									...
									<dl class="fore2"><dt><a href="" target="_blank">国美通信<i>&gt;</i></a></dt>
										<dd>
							...
							<div class="item-sub" id="category-item-5" data-id="5">
								<div class="item-brands">
									<div class="brands-inner">
										<a href="" class="img-link" target="_blank"><img src="../mg/images2/54d9ef34N7cc61f4c.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/5534f4d6N6cf59e34.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/55a5b5baN89a65ec2.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/55b1d930Nf0bfccbb.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/562f4971Na5379aba.jpg" width="83" height="35"></a>
							...
							<div class="item-sub" id="category-item-9" data-id="9">
								...
								<div class="item-promotions">
									<a href="" class="img-link" target="_blank"><img src="img1/images2/577e364eN86c8f187.jpg" width="168" height="134"></a>
									<a href="" class="img-link" target="_blank"><img src="img1/images2/577f5939N38f0a9dc.jpg" width="168" height="134"></a>
								</div>
							</div>
							<div class="item-sub" id="category-item-10" data-id="10">
								<div class="item-brands">
									<div class="brands-inner">
										<a href="" class="img-link" target="_blank"><img src="img1/images2/56f138bfN71952631.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/5534f4d6N6cf59e34.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/55a5b5baN89a65ec2.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/55b1d930Nf0bfccbb.jpg" width="83" height="35"></a>
										<a href="" class="img-link" target="_blank"><img src="img1/images2/562f4971Na5379aba.jpg" width="83" height="35"></a>
								...
								<div class="item-promotions">
									<a href="" class="img-link" target="_blank"><img src="img1/images2/5785154eN49fbd276.jpg" width="168" height="134"></a>
									<a href="" class="img-link" target="_blank"><img src="img1/images2/577f019cN4ea29161.jpg" width="168" height="134"></a>
								</div>
							</div>
							<div class="item-sub" id="category-item-11" data-id="11">
								...
								<div class="item-promotions">
									<a href="" class="img-link" target="_blank"><img src="img1/images2/577f5939N38f0a9dc.jpg" width="168" height="134"></a>
									<a href="" class="img-link" target="_blank"><img src="img1/images2/5784c4c4Nb078a907.jpg" width="168" height="134"></a>
								</div>
							</div>
		...
		<div class="p-item">
			<div class="p-img">
				<a href="//item.jd.com/1514838.html" target="_blank">
					<img src="img/productImage/<%=product.getDetailSmallImg1()%>" width="60px" height="60px" > <!-- src="img1/images2/iphone8plus_addShoppingCartSuccess.jpg" -->
				</a>
			</div>
			<div class="p-info">
				<div class="p-name">
				...
				<div class="p-extra">
					<span class="txt" title="粉">颜色：粉</span><span class="txt" title="全网通">尺码：全网通</span><span class="txt">/  数量：<%=product.getShoppingCarSum() %></span>
				</div></div>
			<div class="clr"></div>
			<div id="p-info-success">
				<a class="btn-tobback" href="javascript:void(0)" onclick="history.back();" >返回</a>
				<a class="btn-addtocart" href="ShoppingCartServlet?action=queryShoppingCart" id="GotoShoppingCart" ><b></b>去购物车结算</a>
			</div>
		</div>
	</div>
	...
	<div id="buyother">
		<div id="similer" class="m1">
			<div class="mt">    
				<h3> 购买了该商品的用户还购买了</h3>    
				<div class="extra-r">      
					<div class="goods-list-tab" id="first-list-tab">        
						<a href="#none" id="selected" class="s-item curr">&nbsp;</a>        
									...
									<div id="item" class="item1">
										<div id="p-img">
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T1zCATB4Yv1RCvBVdK_160.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">纽曼(Newmine) 音乐耳机NM-</br>LK06白  全兼容手机音乐耳机 </a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
								...
								<li>
									<div id="item" class="item1">
										<div id="p-img">
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T18mATBjKT1RCvBVdK_160.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">MUNU袖珍迷你自拍杆  迷你自拍杆</br>自拍杆 便携线控自拍杆  自拍神器</a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
								...
								<li>
									<div id="item"class="item1">
										<div id="p-img">
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T15v_vBQDT1RCvBVdK_160.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">小米 红米Note5A 全网通版</br>4GB+64GB 铂银灰 移动联通电信4G</a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
								...
								<li>
									<div id="item" class="item1">
										<div id="p-img">
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T1lIhTBbCv1RCvBVdK_160.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">魅族 魅蓝Note5 移动全网通</br>4GB+32GB 香槟金</br>4GB+64GB 铂银灰 移动联通电信4G</a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
								...
								<li>
									<div id="item" class="item1">
										<div id="p-img">
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T1b.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">捷波朗劲步通话蓝牙耳机</br>BOOST金</a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
								...
								<li>
									<div id="item" class="item1">
										<div id="p-img">
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T1eCATBvCv1RCvBVdK_160.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">蓝牙耳机 商务蓝牙耳机 通用音乐无</br>线蓝牙耳机 苹果 三星 华为 小米 魅</a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
								...
								<li>
									<div id="item" class="item1">
										<div id="p-img" >
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T1CJJTB_DT1RCvBVdK_160.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">SENNHEISER/森海塞尔 MX80 入门</br>重低音手机电脑耳塞式耳机</a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
								...
								<li>
									<div id="item" class="item1">
										<div id="p-img">
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T1Q6JvBvZg1RCvBVdK_160.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">手机大促 小米 红米Note4X 全网通</br>版 移动联通电信4G手机(樱花粉</a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
								...
								<li>
									<div id="item" class="item1">
										<div id="p-img">
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T1xcKTBXbT1RCvBVdK_160.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">哌 佰客金属指环扣指环扣黑</a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
								...
								<li>
									<div id="item" class="item1">
										<div id="p-img">
											...
											<a href="http://item.jd.com/1502757200.html">
												<img src="img1/img3/T1ObWTBvxv1RCvBVdK_160.jpg"/>
											</a>							
										</div>
										<div id="p-name">
											<a href="http://item.jd.com/1502757200.html">小米(MI) 小米手环2心率监测来</br>电提醒智能运动手环(小米手环2小</a>
										</div>
										<div id="price">
											<strong>
												<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1bSxTBjEb1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">小米(Mi)红米Note4X 高配版 手机</br>4GB+64GB 磨砂黑 </a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1VCLvB5Dv1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">小米(Mi)小米Max2 全网通</br>4GB+64GB 金色 移动联通电信4G手机</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item"class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1dkLTBTAT1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">羽博移动电源S20-1珊瑚蓝(20000毫安)</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li >
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1GmKvBT_g1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">荣耀(honor)荣耀8青春版 尊享版</br>4GB+64GB 全网通版 幻海蓝</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1LcZvBvVg1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">荣耀(honor)荣耀9高配版 </br>6GB+64GB 全网通版 琥珀金</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1tmDvB4CT1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">华为畅享7(SLA-ALOO) 2GB+16GB</br>全网通  双卡 双待 双色</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img" >
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1KmJvBbZs1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">荣耀(honor)V9标配版</br>2GB+16GB 全网通版 幻夜黑</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1uTYTB5bv1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">Mi手机红米4X磨砂黑3GB内存32GB</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1x5ZTBjJv1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">羽博移动电源S8Plus喵女王(20000毫安)</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1V.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">羽博移动电源10000毫安Air玫瑰金</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1DGWTBK_v1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">苏泊尔(supor)TP1638K 32厘米炒</br>锅+22厘米蒸锅 锅具两件套 明火电</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1PvCTBjVT1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">苏泊尔电饭煲CFXB40FC8040-75</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T18ObvBXhv1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">海尔(haier) JSQ24-UT(12T)12升 专</br>利蓝火苗 宽频恒温 6年包修 燃气热</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1evVTBCxg1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">美的(Midea)MG25NF-AD二代25L 三</br>种加热方式 电烤箱 旋转烧烤 黑</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
					...
					<li>
						<div id="item" class="item1">
							<div id="p-img">
								...
								<a href="http://item.jd.com/1502757200.html">
									<img src="img1/img3/T1dmhvBvKj1RCvBVdK_160.jpg"/>
								</a>							
							</div>
							<div id="p-name">
								<a href="http://item.jd.com/1502757200.html">弘基(Acer)蜂鸟 S30-10-506V 14英寸</br>轻薄笔记本电脑(i5-7200U/4G/128G)</a>
							</div>
							<div id="price">
								<strong>
									<em>￥</em>
			...
			<div id="gome-foot-box">
				...
				<div class="qrcode-section">
					...
					<em class="code-bg app">
						<i><a href="#"><img src="img1/3.jpg" /></a></i>
						<p>扫描下载客户端</p>
					</em>
				</div>
				<ul>
		...
		<script type="text/javascript">
			...
			//分页切换按钮
 			$(function(){
 				//产品图片切换一
        var $div_a =$("div.extra-r>#first-list-tab a");
        $div_a.hover(function(){
            ...
            $("#alllist>ul.tab_box li ul ").eq(index).show().siblings().hide(); 
        });		
